...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "swiftformat",
      url: "https://github.com/calda/SwiftFormat-nightly/releases/download/2026-02-19/SwiftFormat.artifactbundle.zip",
      checksum: "73c58b06ebe245585726709c2a4337f77345c1e9da7ab0a3c379dfe7debd1039"
    ),
