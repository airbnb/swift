...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "swiftformat",
      url: "https://github.com/calda/SwiftFormat-nightly/releases/download/2026-03-08/SwiftFormat.artifactbundle.zip",
      checksum: "be0169357320e40861a211fa7c5ffdec944384a7100c9d5168d9b647dfddbf3f"
    ),
